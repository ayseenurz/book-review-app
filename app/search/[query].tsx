...
const Search = () => {
  ...
  useEffect(() => {
    ...
    let apiQuery = query.toLowerCase();

    if (apiQuery.startsWith("author:")) {
      const authorName = apiQuery.replace("author:", "").trim();
  ...
  return (
    <View style={{ flex: 1, padding: 16 }}>
      <FlatList
        ...
        renderItem={({ item }) => <BookListCard book={item} fullWidth />}
